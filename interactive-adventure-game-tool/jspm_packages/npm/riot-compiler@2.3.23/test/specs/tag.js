...
describe('Compile tags', function() {
  ...
  it('The `exclude` option to ignore parts of the tag', function() {
    ...
    expect(compileStr(dummyTag, '', {exclude: ['html']})).to.be(norm("riot.tag2('my-tag', '', 'my-tag,[riot-tag=\"my-tag\"],[data-is=\"my-tag\"]{ color: red; }', '', function(opts) {\nthis.hi = \"hi\"\n});"));
    expect(compileStr(dummyTag, '', {exclude: ['html', 'js']})).to.be(norm("riot.tag2('my-tag', '', 'my-tag,[riot-tag=\"my-tag\"],[data-is=\"my-tag\"]{ color: red; }', '', function(opts) {\n});"));
